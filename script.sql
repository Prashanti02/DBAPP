...
(
  delegateID VARCHAR(50) NOT NULL,
...
INSERT INTO `delegates`(`delegateID`, `delName`, `committeeN`, `assignedCountry`, `ID`) VALUES (2103,"Heather Mouuse","SOCHUM","USA", 5);
INSERT INTO `delegates`(`delegateID`, `delName`, `committeeN`, `assignedCountry`, `ID`) VALUES (2104,"Jason K","UNDP","Brazil", 4);
